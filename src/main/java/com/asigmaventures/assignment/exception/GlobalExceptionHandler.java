...
import com.asigmaventures.assignment.config.AppConfig;
...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    @ExceptionHandler({AsigmaServiceException.class})
    public Mono<ResponseEntity<ErrorResponse>> handleMaskingPatternException(AsigmaServiceException ex) {
